...
const Page = async ({ params }) => {
  const workstation = await getWorkStationChairData(params.productid);
  return (
    <>
      ...
      <div className="w-72">
        ...
        <div className="flex flex-col justify-between leading-normal pl-0 md:pl-20">
          ...
          <div className="font-normal text-sm text-gray-700 space-y-2">
            <p>
                Model No. : {workstation.ModelNo}
            </p>
            <p>
                Type : {workstation.Type}
            </p>
            <p>
                Fabric : {workstation.Fabric}
            </p>
            <p>
                Mechanism : {workstation.Mechanism}
            </p>
            <p>
                Armrest : {workstation.Armrest}
            </p>
            <p>
                Mechanism : {workstation.Mechanism}
            </p>
            <p>
                BodyColor : {workstation.BodyColor}
            </p>
            <p>
                Base Material : {workstation.BaseMaterial}
            </p>
            <p>
                Height Adjuster : {workstation.HeightAdjuster}
            </p>
