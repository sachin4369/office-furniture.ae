...
const getCafeTableData = async (id) => {
    try {
        ...
        let data = await fetch(`${apiUrl}/api/cafetableapi/${id}`);
  ...
  const Page = async ({ params }) => {
    try {
        const table = await getCafeTableData(params.productid);
        console.log(table);
        return(
            <>
          ...
          <div className="flex flex-col items-center bg-white border pl-0 md:mb-10 md:pl-20 border-gray-200 rounded-lg shadow md:flex-row dark:border-gray-700 dark:bg-gray-800 p-4">
            ...
            <div className="flex flex-col justify-between leading-normal pl-0 md:pl-20">
              ...
              <div className="font-normal text-sm text-gray-700 space-y-2">
                ...
                <p>
                    Base Material : {table.BaseMaterial}
                </p>
                <p>
                    Height Adjuster : {table.HeightAdjuster}
                </p>
